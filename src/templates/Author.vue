    ...
    <main>
      <header>
        ...
        <nav class="absolute pin-t pin-l z-20 mt-6 ml-6">
          <g-link to="/" class="text-sm border text-grey-darkest border-grey-dark opacity-75 hover:opacity-100 rounded-full no-underline px-4 py-2 transition-opacity">&larr; Beranda</g-link>
        </nav>
      </header>
      <section>
